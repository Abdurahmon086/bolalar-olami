...
<template>
 ...
 <p class="author-about--text darkMode-title">Firdavs Muzafarov. 2001 yiI Sirdaryo viIoyatining Guliston shahrida tug'ilgan. MilIati — 0'zbek. o'zbekiston
    Jurnalistika va ommaviy kommunikatsiyalar universitetining 4-bosqich talabasi.</p>
   ...
   <img class="img-fluid w-100" src="/images/profilImages/img1.png" alt="img" />
    <span class="darkMode author-card-sp position-absolute">Salomatlik</span>
      ...
      <div class="author-card__info darkMode">
        ...
        <p class="darkMode-sp author-card__info-time">
            12.12.2023  12:32</p>
  </div>
     </div>
     <div class="darkMode author-card-box text-decoration-none">
