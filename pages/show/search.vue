...
<template>
    ...
    <section class="container">
       ...
       <div class="search-result__card">
        <div class="search-result__card-wrapper position-relative">
            <img src="/images/searchImages/img1.png" class="img-fluid w-100" alt="img">
            <div class="search-result__card-wrapper-box position-absolute w-100 h-100">
                <p class="search-result__card-wrapper-text position-absolute position-absolute">
        ...
        <div class="search-result__card-wrapper position-relative">
            <img src="/images/searchImages/img1.png" class="img-fluid w-100" alt="img">
            <div class="search-result__card-wrapper-box position-absolute w-100 h-100">
                <p class="search-result__card-wrapper-text position-absolute">
                    Yaponiyada tug‘ilishlar soni keskin kamaydi
                </p>
            </div>
        </div>
    ...
    <section class="lastNews">
        <div class="container">
            <div class="lastNews__wrapper search-news">
