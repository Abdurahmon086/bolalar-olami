    ...
    <main class="darkMode-body pb-5 bg-light">
        <section class="darkMode-body">
            <div class="container">
                            ...
                            <div class="talim-cardimg__left-wrapper darkMode">
                                ...
                                <div class="talim-cardimg__left-wrapper-box">
                                    <h4 class="talim-cardimg__left-wrapper-title darkMode-title">
                                        Yuz kunda 10,000 bola vafot etdi – G'azo
                                        SSV
                                    </h4>
                                    <p class="talim-cardimg__left-wrapper-text darkMode-title">
                                        G'azo sog'liqni saqlash vazirligining
                                        ma'lum qilishicha, Isroil tomonidan
                                        qariyb 100 kundan buyon amalga ...
                                    </p>
                        ...
                        <ul class="lastNews__right-list list-unstyled darkMode">
                            <li class="border-bottom">
                                ...
                                <div
                                    ...
                                    <span class="lastNews__right-sp lastNews__right-spDate darkMode-sp">12.12.2023</span>
                                </div>
                            </li>
                            <li class="border-bottom">
                                <p class="lastNews__right-text darkMode">
                ...
                <img src="/public/images/talimImages/reklama-y-img.png" class="img-fluid pt-3" alt="" />
            </div>
        </section>
                ...
                <div class="talim-cardimg">
                    ...
                    <aside class="talim-cardimg__aside">
                        ...
                        <img src="/public/images/talimImages/reklama-img2.png" class="img-fluid talim-cardimg__aside-img2"
                            alt="reklama-img" />
                        <img src="/public/images/talimImages/reklama-img3.png" class="img-fluid talim-cardimg__aside-img3"
                            alt="reklama-img" />
                    </aside>
                </div>
            </div>
