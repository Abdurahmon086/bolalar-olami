...
<template>
    <main class="darkMode-body pb-5 bg-white">
        ...
        <section class="container darkMode-body">
            <div class="mediacate">
                <h2 class="mediacate__text darkMode-title">BIZNING GALEREYA</h2>
                <div class="mediacate__card">
                    <div class="mediacate__card-box position-relative">
                        <img
                            src="/images/mediacategoryImages/mediaimg1.png"
                            class="img-fluid mediacate__card-img"
                            alt="GALEREYA img"
                        />
                        <div
                            class="mediacate__card-posi position-absolute w-100"
                        >
                            <div>
                                <h3
                                    class="mediacate__card-posi--title fw-medium text-white hidden-text-3"
                                >
                                    {{
                                ...
                                <h3
                                    class="mediacate__card-posi--title fw-normal"
                                >
                                    5 Videos
                                </h3>
                            </div>
                            <NuxtLink
                                :to="store.datas.bannerVideos[0].youtube_link"
                                class="d-block"
                            >
                                <img
                    ...
                    <div class="mediacate__card-box1">
                        <div class="position-relative">
                            ...
                            <div
                                class="mediacate__card-bottom position-absolute w-100"
                            >
                                <div>
                                    ...
                                    <p
                                        class="mediacate__card-bottom--text1 fw-normal"
                                    >
                                        32 Videos
                                    </p>
                                </div>
                ...
                <div class="mediacate__galle">
                    ...
                    >
                        <img
                            src="/images/mediacategoryImages/imggalleriya.png"
                            class="img-fluid"
                            alt="gallery-img"
                        />
                        <NuxtLink :to="item.youtube_link" class="d-block">
                            <img
                                src="/images/mediacategoryImages/group-icon.svg"
                                class="position-absolute mediacate__galle--icon"
                                alt="icon"
                            />
                        </NuxtLink>
                    </div>
            ...
            <div v-for="items in store.datas?.videoCategories">
                ...
                <div class="mediacate__all">
                    <template v-if="!store.isActive(items)">
                        ...
                        >
                            <img
                                src="/images/mediacategoryImages/all-img.png"
                            ...
                            >
                                <div>
                                    <p
                                        class="mediacate__all-box-text fw-medium text-white hidden-text-3"
                                    >
                                        {{ item[`title_${$i18n.locale}`] }}
                                    </p>
                                    <p
                                        class="mediacate__all-box-text fw-normal"
                                    >
