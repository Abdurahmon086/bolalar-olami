        ...
        <footer class="darkMode bg-white">
            <div class="footer container">
                <div class="footer__card row">
                    <div class="col">
                        <a href="#">
                            ...
                            <img
                                ...
                                class="darkIcon d-none img-fluid"
                                alt="bolalar olami Logo"
                                loading="lazy"
                            />
                        </a>
                    ...
                    <div class="col">
                        <ul
                            class="footer__list list-unstyled d-flex flex-column"
                            style="gap: 24px"
                        >
                            <li>
                                <a
                ...
                <div style="margin-top: 20px">
                    <p
                        class="mb-0 footer__co-text text-center fw-normal darkMode-sp"
                    >
