...
<template>
    <footer class="darkMode bg-white">
        <div class="container">
            <div class="footer">
                <div class="footer__card d-flex justify-content-between">
                    <div class="">
                    ...
                    <div class="">
                        <ul class="footer__list list-unstyled d-flex flex-column" style="gap: 24px">
                            ...
                            <li>
                                <a class="footer__link1 fw-bold text-decoration-none darkMode-title"
                                    href="#">{{ $t("gNumber") }}</a>
                            </li>
                            <li>
                                <a class="footer__link1 fw-bold text-decoration-none darkMode-title" href="#" style="
                                        display: block;
                    ...
                    <div class="">
                        <ul class="list-unstyled d-flex flex-column" style="gap: 24px">
                            ...
                            <li class="d-flex align-items-start" style="gap: 6px">
                                ...
                                <a class="footer__link1 fw-normal text-decoration-none darkMode-title" href="#"
                                    style="display: block; max-width: 230px">{{ $t("place") }}</a>
                            </li>
                        </ul>
                    </div>
                    <div class="">
