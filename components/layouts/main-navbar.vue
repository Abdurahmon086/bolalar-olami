                ...
                <div class="container header__top d-flex justify-content-between align-items-center">
                    ...
                    <div class="header__top-right d-flex align-items-center">
                        ...
                        <div class="header__top-menuList d-flex align-items-center" style="gap: 16px">
                            <NuxtImg src="/images/glasses.svg" width="20" height="20" alt="glasses icon" class="lightIcon d-block" />
                            <NuxtImg src="/images/glasses_d.svg" width="20" height="20" alt="glasses icon" class="darkIcon d-none" />
                            <div id="themingSwitcher" @click="togglrMode">
                                <NuxtImg src="/images/moon.svg" width="16" height="16" alt="moon icon" class="lightIcon d-block cur" />
                                <NuxtImg src="/images/moon_d.svg" width="16" height="16" alt="moon icon" class="darkIcon d-none" />
                            </div>
                            <button
                                @click="(mainStore.auth = true), (mainStore.auths = false)"
                                type="button"
                            ...
                            <select class="header__top-btn darkMode-btn d-xl-none" aria-label="Default select example" v-model="language">
                            ...
                            <ul class="header__top-list d-none d-xl-flex align-items-center list-unstyled m-0" style="gap: 10px">
                                <li class="header__top-item darkMode" :class="{ active: $i18n.locale === 'uz' }" @click="changeLocale('uz')">Uz</li>
                                <li class="header__top-item darkMode" :class="{ active: $i18n.locale === 'kr' }" @click="changeLocale('kr')">Уз</li>
                                <li class="header__top-item darkMode" :class="{ active: $i18n.locale === 'en' }" @click="changeLocale('en')">En</li>
                                <li class="header__top-item darkMode" :class="{ active: $i18n.locale === 'ru' }" @click="changeLocale('ru')">Ру</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <nav class="header__navbar navbar navbar-expand-xl navbar-light shadow-0 darkMode">
                    <div class="container darkMode">
                        ...
                        <NuxtLink :to="localPath('/')" class="navbar-brand m-0">
                            <NuxtImg src="/images/logo.svg" class="lightIcon d-block" width="135" height="40" alt="bolalar olami Logo" />
                            <NuxtImg src="/images/logo_d.svg" class="darkIcon d-none" width="135" height="40" alt="bolalar olami Logo" />
                        </NuxtLink>
                        ...
                        <div class="darkMode navbar-collapse header__navbar-middle collapse" id="navbarSupportedContent">
                            ...
                            <ul class="darkMode navbar-nav d-none d-xl-flex justify-content-center w-100">
                                ...
                                <li class="nav-item position-relative darkMode" v-for="nav in datas" :key="nav.id">
                                    <NuxtLink
                                        class="nav-link darkMode-title d-flex align-items-center"
                                    ...
                                    >
                                        ...
                                        <NuxtImg
                                            src="/images/bottom-icon.svg"
                                            class="mt-1 lightIcon d-block"
                                            alt="bottom-icon"
                                            width="10"
                                            v-if="!mainStore.darkTheme"
                                        />
                                        <NuxtImg src="/images/bottom-icon-dark.svg" class="darkIcon mt-1" alt="bottom-icon" width="10" v-else />
                                    </NuxtLink>
                                    <div class="darkMode d-none item-menu list-group list-group-light position-absolute">
                                        <button
                                            ...
                                            v-for="item in nav.child"
                                            :key="item.id"
                                        >
                                            <NuxtLink
                                                :to="localPath(`/${item.slug_uz}/?id=${item.id}`)"
                                                class="text-decoration-none darkMode"
                                                style="color: #000"
                                            >
                                ...
                                <div class="accordion-item darkMode-btn" v-for="menu in datas" :key="menu.id">
                                    <h2 class="accordion-header">
                                        <button
                                            ...
                                            :data-bs-target="'#flush-collapseOne' + menu.id"
                                            aria-expanded="true"
                                            :aria-controls="'flush-collapseOne' + menu.id"
                                        >
                                            <NuxtLink
                                                :to="localPath(`/${menu.slug_uz}/?id=${menu.id}`)"
                                                class="text-decoration-none darkMode"
                                                style="color: #000"
                                            >
                                    ...
                                    >
                                        <ul class="accordion-body list-unstyled">
                                            <li v-for="navItem in menu.child" :key="navItem.id" @click="navgateToggle(true)">
                                                <NuxtLink
                                                    :to="localPath(`/${navItem.slug_uz}/?id=${navItem.id}`)"
                                                    class="text-decoration-none darkMode"
                                                    style="color: #000"
                                                >
                                                    <p class="m-0">
                        ...
                        <div class="header__navbar-right d-flex align-items-center darkMode">
                            <div type="button" class="darkMode-btn btn shadow-0 header__navbar-btn" @click="searchStore.modal = true">
                                <NuxtImg src="/images/search.svg" width="24" height="24" class="lightIcon d-block" alt="search icon" />
                                <NuxtImg src="/images/search_d.svg" width="24" height="24" class="darkIcon d-none" alt="search icon" />
                            </div>
                            ...
                            <button
                                ...
                                :aria-expanded="navgateValue ? false : true"
                                aria-label="Toggle navigation"
                                class="darkMode-btn navbar-toggler header__navbar-btn d-xl-none"
                                :class="navgateValue ? 'collapsed' : ''"
                                @click="navgateToggle(false)"
                            >
                                <template v-if="!mainStore.darkTheme">
                                    <NuxtImg src="/images/x.svg" width="24" height="24" alt="x icon" class="" />
                                    <NuxtImg src="/images/menu.svg" width="24" height="24" alt="menu icon" class="d-none" />
                                </template>

                                <template v-else>
                                    <NuxtImg src="/images/x.svg" width="24" height="24" alt="x icon" class="" />
                                    <NuxtImg src="/images/menu-d.svg" width="24" height="24" alt="menu icon" class="d-none" />
                                </template>
                            </button>
                            <!-- Avatar -->
                            ...
                            <template v-if="mainStore.authed">
                                <div class="dropdown">
                                    <a
                                        ...
                                        aria-expanded="false"
                                    >
                                        <NuxtImg src="/images/person.png" class="rounded-circle" height="35" alt="person" loading="lazy" />
                                    </a>

                                    <!-- width uzi 182px  -->
                                    <ul class="darkMode dropdown-menu dropdown-menu-end" style="width: 192px" aria-labelledby="navbarSupportedContent">
                                        <li class="darkMode d-flex align-items-start" style="gap: 8px; padding: 10px 10px 4px 10px">
                                            <NuxtImg src="/images/person.png" class="rounded-circle" height="35" alt="person" loading="lazy" />

                                            <div>
                                                <h4 class="m-0" style="font-size: 14px; line-height: 20px">Firdavs Muzaffarov</h4>
                                                <span style="color: rgba(36, 36, 36, 0.5); font-size: 11px; line-height: 20px" class="darkMode-sp"
                                                    >info@gmail.com</span
                                                >
                                            </div>
                                        </li>
